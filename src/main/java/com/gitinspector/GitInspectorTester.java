...
public class GitInspectorTester {
    ...
    public static final List<String> TEAM_GIT_ORG_NAMES = Arrays.asList("");
    public static final List<String> TEAM_NON_ORG_REPOS = Arrays.asList("");

    private GitHub gitHub;

    public static void main(String args[]) throws IOException, InterruptedException {
        // for manual testing only if you don't want to do mvn jetty:run and let the scheduled tasks run
        GitInspectorTester gitInspector = new GitInspectorTester("http://yourgithubserver", "replace me with your token");
